...
describe("Acccess the oncology platform",()=>{
    beforeEach(()=>{
      ...
      it.only("test1-tests fucntionality of the registration module",()=>{
        ...
        cy.get('input[name="query"]').type("Wednesday",{enter:true})
        cy.get(':nth-child(4) > table > tbody > tr > td.ng-binding > strong.ng-binding').click()
        ...
        //cy.contains("Print to file").click()
