...
describe("Acccess the oncology platform",()=>{
    beforeEach(()=>{
      ...
      it.only("test1-tests fucntionality of the registration module",()=>{
        ...
        cy.get("#idValue").type("482901939{enter}")
        cy.get('input[name="nationalIdNumber"]').type("482901939").should("be.visible")
        cy.get('input[name="other-identifiers"]').check()
        cy.get('input[name="personName.familyName"]').type("Tes")
        cy.get('input[name="personName.givenName"]').type("Mwangi")
