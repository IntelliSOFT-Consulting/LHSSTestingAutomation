...
describe("Acccess the oncology platform",()=>{
    beforeEach(()=>{
      ...
      it.only("test1-tests fucntionality of the registration module",()=>{
        ...
        cy.get("#idValue").type("447820207{enter}")
        cy.get('input[name="nationalIdNumber"]').type("447820207").should("be.visible")
        cy.get('input[name="other-identifiers"]').check()
        cy.get('input[name="personName.familyName"]').type("Last")
        cy.get('input[name="personName.givenName"]').type("February")
